 ...
 * @author user
 */
public class ViewMedicles extends javax.swing.JFrame implements TableManagement{
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Student ID", "File Name", "Date", "View"
            }
        ) {
        ...
        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 150, 1250, 530));

        setSize(new java.awt.Dimension(1266, 717));
      ...
      public void ShowTable() {
        ...
        try {
            String sql="Select userID ,MedicalName,MedicleContent,Date from medical WHERE userID='"+sid+"'";
    ...
    if (row >= 0) {
       dateString1 = jTable1.getValueAt(row, 3).toString();
