...
public void modifyPanel() {
    ...
    private void initComponents() {
        ...
        DragablePannel.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Submition Medicle", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(51, 51, 51))); // NOI18N
        ...
        jPanel3.add(DragablePannel, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 210, 740, 140));
        ...
        jPanel4.add(TypeCombo, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 90, 170, -1));

        C_id.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select", "ICT01", "ICT02", "ICT03", "ICT04", "ICT05", "TMS01", " " }));
        jPanel4.add(C_id, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 90, 170, -1));

        jLabel12.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel12.setText("Course ID");
        jPanel4.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 90, -1, -1));
        jPanel4.add(med_id, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 120, 170, -1));

        jPanel3.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 40, 740, 160));
...
private void insertMedicalInfo(String sid,String cid) {
    
    this.sid = sid;
    String tpe = (String) TypeCombo.getSelectedItem();
    ...
    try {
        ...
        String sql = "INSERT INTO medical (userID, MedicleContent, MedicalName,Date,MedID) VALUES (?, ?, ?,?,?)";
        ...
        pst4.setString(4,dateString);
        pst4.setString(5,medID);
        pst4.executeUpdate();
...
// Call the insertMedicalInfo method when the submit button is clicked
//private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {
//    String sid = s_id.getText();
//    if (sid.isEmpty()) {
//        JOptionPane.showMessageDialog(null, "Can't be Empty Any filed");
//    } else {
//        insertMedicalInfo(sid,);
//    }
//}
...
String dateString = dateFormat.format(selectedDate);
 ...
 // Assuming C_id is a text field

if (!sid.isEmpty() && !cid.isEmpty()&& !dateString.isEmpty()) {
    insertMedicalInfo(sid,cid); // Assuming insertMedicalInfo() requires sid and C_id as parameters
} else {
